<template>
  <div>
    <form id="pedido-form" @submit="criarPedido($event)">
      <!--*usa o $ pq o evento é do JS, não do vue -->
      <!-- Foto e titulo -->
      <div>
...
export default {
  ...
  methods: {
    ...
    async criarPedido(e) {
      ...
      await fetch('http://localhost:3000/pedidos', { // o método REST usado agora é POST ao invés do GET.
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: dadosJson, // GET não tem body, mas a requisição do POST tem
      });
    },
  },
  mounted() {
